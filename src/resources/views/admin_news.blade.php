                    ...
                    <div class="card">
  						...
  						<div class="card-body">
  							<ul class="nav justify-content-center nav-tabs">
  								...
  								<li class="nav-item">
    								<a class="nav-link active" href="/admin/news">Новости</a>
  								</li>
  								<li class="nav-item">
    								<a class="nav-link" href="/admin/support">Техническая поддержка</a>
  								</li>
							</ul>
							<form method="POST" action="/admin/news/add">
                                @csrf
                                <div class="form-group">
                                	<input type="text" class="form-control mt-3" name="title" placeholder="Заголовок">
                                    <textarea class="form-control mt-3" rows="4" placeholder="Введите текст" name="text"></textarea>
                                    <button type="submit" class="btn btn-primary btn-block mt-3">Опубликовать</button>
                                </div>
                            </form>
						</div>
					</div>
